...
// import users from '@/assets/data/users.json'; // Adjust the path as needed
...
export function UserPortfolioNav({ scroll = false }: NavBarProps, name: string) {
    ...
    const links =
        (selectedLayout && configMap[selectedLayout]) || portfolioConfig.mainNav;
